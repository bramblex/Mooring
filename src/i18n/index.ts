...
const messages = {
  en: {
    ...
    deleteWorkspaceConfirm: "Delete this workspace? Pinned tabs will remain documented as bookmarks later.",
    pinTab: "Pin tab",
    unpinTab: "Unpin tab",
    unpinTabConfirm: "Unpin this tab? It will no longer be restored with this workspace.",
    pinnedTabDirty: "Current page differs from the pinned bookmark",
    closeTab: "Close tab",
    ungroup: "Ungroup",
  },
  zh: {
    ...
    deleteWorkspaceConfirm: "确定删除这个 Workspace 吗？后续实现中，固定标签页会按书签规则处理。",
    pinTab: "固定标签页",
    unpinTab: "取消固定标签页",
    unpinTabConfirm: "确定取消固定这个标签页吗？它将不再跟随 Workspace 恢复。",
    pinnedTabDirty: "当前页面已偏离固定书签",
    closeTab: "关闭标签页",
    ungroup: "取消分组",
  },
} as const;
